    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[95vw] sm:max-w-xl md:max-w-2xl max-h-[90vh] overflow-y-auto p-4 sm:p-6">
        <DialogHeader>
          ...
          <DialogTitle className="text-xl sm:text-2xl">Boleto Bancário Gerado</DialogTitle>
        </DialogHeader>

        <Card className="p-4 sm:p-6 bg-background border-2">
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-xs sm:text-sm">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Conta: {boleto.conta}</p>
              </div>
              <div>
            ...
            <div>
              <p className="text-muted-foreground mb-2 text-xs sm:text-sm">Pagador</p>
            ...
            <div>
              <p className="text-muted-foreground mb-2 text-xs sm:text-sm">Linha Digitável</p>
              <div className="bg-muted p-2 sm:p-3 rounded font-mono text-xs sm:text-sm break-all">
                {boleto.linhaDigitavel}
              </div>
              <Button
                variant="outline"
                size="sm"
                className="w-full mt-2 bg-transparent text-xs sm:text-sm"
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <Button onClick={downloadBoleto} className="flex-1 text-sm">
