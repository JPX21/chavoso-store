...
import { ShoppingCart, User, Settings, LogIn, UserPlus, Zap, LayoutDashboard, Menu } from "lucide-react"
            ...
            <DropdownMenu modal={false}>
              <DropdownMenuTrigger asChild>
                ...
                >
                  ...
                  {user && <span className="hidden lg:inline">{user.name.split(" ")[0]}</span>}
                </Button>
              </DropdownMenuTrigger>
