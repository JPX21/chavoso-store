      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            <h1 className="text-3xl md:text-4xl font-bold mb-3 md:mb-4">Entre em Contato</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-8 md:mb-12">
            {contactMethods.map((method) => (
              <Card key={method.title} className="p-4 md:p-6 bg-card">
                <method.icon className="h-8 w-8 md:h-10 md:w-10 text-accent mb-3 md:mb-4" />
                <h3 className="text-lg md:text-xl font-semibold mb-2 text-card-foreground">{method.title}</h3>
                <p className="text-foreground font-medium mb-1 text-sm md:text-base">{method.description}</p>
          ...
          <Card className="p-6 md:p-8 bg-card">
            <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-6 text-card-foreground">Envie uma Mensagem</h2>
