...
import { Trash2, Tag, Loader2, Download, Package } from "lucide-react"
...
export default function CarrinhoPage() {
  ...
  const finalizarCompra = async () => {
    if (metodoPagamento === "boleto") {
      ...
      alert(`Compra finalizada com ${metodoPagamento}! Total: R$ ${totalPrice.toFixed(2)}`)
      clearCart()
    }
  }
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        <h1 className="text-3xl md:text-4xl font-bold mb-6 md:mb-8">Carrinho de Compras</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-6 md:gap-8">
              ...
              <Card key={item.id} className="p-4">
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    {item.gameType === "physical" && item.endereco && (
                      <div className="mt-2 text-xs text-muted-foreground">
                        <p>
                          Entrega: {item.endereco.logradouro}, {item.endereco.bairro}
                        </p>
                        <p>
                          {item.endereco.localidade} - {item.endereco.uf}, CEP: {item.endereco.cep}
                        </p>
                      </div>
                    )}
                    <p className="text-lg md:text-xl font-bold text-primary mt-2">R$ {item.price.toFixed(2)}</p>
                  </div>
                  <Button
                    variant="ghost"
                    size="icon"
          ...
          <div className="space-y-4 md:space-y-6">
            <Card className="p-4 md:p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <Input
                  ...
                  className="flex-1"
                />
                <Button onClick={aplicarCupom} disabled={cupomAplicado} className="w-full sm:w-auto">
            ...
            <Card className="p-4 md:p-6">
              <h3 className="font-semibold text-base md:text-lg mb-4">Método de Pagamento</h3>
              <RadioGroup value={metodoPagamento} onValueChange={setMetodoPagamento}>
                ...
                <div className="flex items-center justify-between space-x-2 mb-3 opacity-50">
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="credito" id="credito" disabled />
                    <Label htmlFor="credito" className="cursor-not-allowed">
                      Cartão de Crédito
                    </Label>
                  </div>
                ...
                <div className="flex items-center justify-between space-x-2 mb-3 opacity-50">
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="debito" className="cursor-not-allowed">
                      Cartão de Débito
                    </Label>
                  </div>
                  <Badge variant="secondary" className="text-xs">
            ...
            <Card className="p-4 md:p-6">
              <h3 className="font-semibold text-base md:text-lg mb-4">Resumo do Pedido</h3>
              ...
              <Button
                ...
                disabled={loadingBoleto || loadingPix}
              >
                {loadingBoleto ? (
                  <>
      ...
      <PixModal open={pixModalOpen} onOpenChange={setPixModalOpen} pix={pixData} />
